...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "App","app",0,"app.core.js","es5-build-disabled.js","hydrated","app-home,app-profile,app-root,ion-animation-controller,ion-app,ion-back-button,ion-backdrop,ion-button,ion-buttons,ion-content,ion-fab,ion-fab-button,ion-header,ion-icon,ion-item,ion-label,ion-loading,ion-loading-controller,ion-nav,ion-ripple-effect,ion-route,ion-router,ion-spinner,ion-title,ion-toast,ion-toast-controller,ion-toggle,ion-toolbar",HTMLElement.prototype);